...
<div class="statvoo_container_1">
	...
	<div class="statvoo_view_left" onclick="var win=window.open('https://www.statvoo.com/view/<?=$domain;?>/overview/realtime', '_blank');win.focus();">
		<h2>View your stats!</h2>
		<div>View this site's statistics directly on <a href="https://www.statvoo.com/view/<?=$domain;?>/overview/realtime" target="_blank">Statvoo.com</a></div>
	</div>
