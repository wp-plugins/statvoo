...
<div class="statvoo_container_1">
	...
	<div class="statvoo_view_left" onclick="var win=window.open('http://www.statvoo.com/view/<?=$domain;?>/overview/realtime', '_blank');win.focus();">
		<h2>View your stats!</h2>
		<div>View this site's statistics directly on <a href="http://www.statvoo.com/view/<?=$domain;?>/overview/realtime" target="_blank">Statvoo.com</a></div>
	</div>
	<div class="statvoo_register_right" onclick="var win=window.open('http://www.statvoo.com/auth/register', '_blank');win.focus();">
		<h2>Get Started..</h2>
		<div>First time you're using Statvoo on this site? <a href="http://www.statvoo.com" target="_blank">Statvoo.com</a></div>
	</div>
	<br clear="all"/>
